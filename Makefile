...
PETSc.pc := /opt/local/lib/petsc/lib/pkgconfig/PETSc.pc
...
md_params.o: md_params.F90 
	$(COMPILE.F)   $<

md_vector.o:md_vector.F90
	$(COMPILE.F)   $<

md_cube.o:md_cube.F90
	$(COMPILE.F)   $<


md_dmatrix.o:md_dmatrix.F90 
	$(COMPILE.F)  $<
...
md_integration.o:md_integration.F90 
	$(COMPILE.F)  $<

md_tendency.o: md_tendency.F90 
	$(COMPILE.F)  $<
...
md_vector.o : md_params.o
md_cube.o : md_params.o md_vector.o
md_dmatrix.o : md_params.o md_vector.o 
initial_condition.o : md_params.o md_vector.o 
md_io.o : md_params.o md_vector.o 
md_tendency.o : md_params.o md_vector.o md_dmatrix.o 
md_integration.o :md_params.o md_io.o md_vector.o  md_cube.o md_dmatrix.o md_tendency.o
